...
## Caso 1 — «El Códice de Jade» (fácil)
...
| Tomás Iriarte | 77 | No tuvo oportunidad (estaba en el jardín, no adyacente a la sala) |
...
maestra (acceso), cámara que lo sitúa en el vestíbulo a las 21:20 (oportunidad),
expediente de despido abierto por la víctima (motivo) y ambos medios requeridos
—código de alarma y llave de vitrina—. Su coartada la sostiene Julio Caña, cuyo
...
| Dra. Carla Ríos | 87 | Coartada válida (Dora Quintana), pese a tener medios y motivo |
| Hugo Bravo | 62 | Sin acceso a la sala de medicación y sin oportunidad |
| Pablo Mena | 52 | Sin acceso a controlados y sin motivo |

**Qué lo hace más difícil que el caso 1.** *Dos* sospechosas cuentan con todos
...
## Caso 3 — «El código fuente robado» (difícil)
...
| Darío Peña | 87 | Coartada válida (Omar Beltrán), pese a medios y motivo |
| Kenji Mora | 47 | Sin acceso a la sala de servidores, sin todos los medios, sin motivo |
| Lucía Ferrer | 37 | Sin oportunidad (estaba en recepción) y sin motivo |

**Qué lo hace el más difícil.** La evidencia más llamativa apunta al sospechoso

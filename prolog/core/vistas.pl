...
% Predicados que entregan una fila por solución con valores ya redactados.
%
% Al redactar en Prolog, los otros componentes solo necesitan mostrar el texto,
% manteniendo la lógica deductiva contenida en este módulo.

% hora_texto(+HHMM, -Texto)
% Convierte el entero numérico (ej. 2130) en texto legible ('21:30').
...
% Transforma un identificador en su nombre legible correspondiente.
% Si no se encuentra traducción, mantiene el identificador original.
...
% Escribe el justificativo de una deducción en lenguaje natural.
...
% Texto predeterminado para razones no registradas.
...
% Sospechosos sin coartada declarada.
...
% Muestra únicamente las que involucren elementos descubiertos hasta el momento.

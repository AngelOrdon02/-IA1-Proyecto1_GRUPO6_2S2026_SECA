...
%   - elena  -> descartada por coartada valida y por falta de acceso
%   - nadia  -> descartada por falta de motivo y de medios
%   - tomas  -> descartado por falta de oportunidad y de acceso
%   - marco  -> RESPONSABLE: acceso + oportunidad + motivo + medios, miente
%               y su coartada queda refutada por la evidencia.
...
% ---------------------------------------------------------------------------
% ACCESOS
% Marco tiene credencial maestra. Nadia entra a la sala guiando visitas.
% Elena solo llega al deposito. Tomas es un invitado sin permisos internos.
% ---------------------------------------------------------------------------
...
% COARTADAS
% ---------------------------------------------------------------------------
coartada(caso1, marco, oficina_seguridad, 2120, julio).  % julio miente -> invalida
coartada(caso1, elena, deposito,          2115, rosa).   % rosa es fiable -> valida
coartada(caso1, nadia, vestibulo,         2110, tomas).  % tomas es sospechoso -> invalida
coartada(caso1, tomas, jardin,            2118, julio).  % julio miente -> invalida
...
% ---------------------------------------------------------------------------
% MEDIOS
% El robo exigia desactivar la alarma Y abrir la vitrina blindada.
% ---------------------------------------------------------------------------
...
personal_interno(caso1, Persona) :-
    ...
    once(( acceso(caso1, Persona, _, Tipo),
           pertenece(Tipo, [credencial_maestra, credencial_personal, credencial_guia,
                            llave_restauracion, llave_mantenimiento]) )).
...
% primer candidato que abre la vitrina y descartaria a los demas, aunque ese
% primero no cumpliera el resto de condiciones.
